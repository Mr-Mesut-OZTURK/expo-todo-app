  ...
  try {
    palaDB.transaction((tx) => {
      tx.executeSql(
        ...
        undefined,
        () => null, // console.log("todos table created successfully"),
        (_, error): boolean | any => {
...
const todoTableAlter = () => {
  palaDB.transaction((tx) => {
    tx.executeSql(
      ...
      [],
      () => null, // console.log("categories table updated successfully"),
      (_, error): boolean | any => {
...
const updateTodoCompletion = (id: string, completed: any, callback?: any) => {
...
const deleteTodo = (id: string, callback?: any) => {
  palaDB.transaction((tx) => {
